...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Pesacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pesacointools.com", "127.0.0.1"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"pesacointools.com", "testnet-seed.pesacointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Pesacoin is probably already running."), addrBind.ToString().c_str());
        else
